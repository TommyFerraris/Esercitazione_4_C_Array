...
bool ImportVector(const string& FileInput, double& S, size_t& n, double*& w, double*& r){

    // open file and check of correct opening:
    ifstream file;
    file.open(FileInput);
    ...
    // Eliminate third line:
    string header;
    getline(file, header);

    // create vectors w and r:
    string frazione;
    string revenue;
    w = new double[n];
    r = new double[n];
